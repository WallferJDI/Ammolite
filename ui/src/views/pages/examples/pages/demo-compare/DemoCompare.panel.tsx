...
import { AuthHeader } from "@/views/layout/headers";

export const DemoComparePanel = (): JSX.Element => {
  return (
    <>
      <>
          ...
          <div className="d-flex justify-content-lg-center px-3 mt-5">
            ...
            <Col lg="6">
              <p className="text-white">
                <strong>The Arctic Ocean</strong> freezes every winter and much of the sea-ice then
